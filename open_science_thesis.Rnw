...
%%% Usage: Collaborative scientific document writing 
%%% Author: Claas-Thido Pfaff
%%%------------------------------------------------------------------------------------%%
%%%------------------------------------------------------------------------------------%%

%%%------------------------------------------------------------------------------%%%
%%% Document class: open_science_thesis (Based on Koma-Script: article) %%%
%%%------------------------------------------------------------------------------%%%
%%
%

\documentclass[linenumbers=false, color=false]{ost/subdocuments/open_science_thesis} 
...
<<glossary_definitions, child='usr/subdocuments/open_science_glossary.Rnw', eval=TRUE>>=
@
...
<<global_knitr_options, child='usr/subdocuments/ost_global_knitr_options.Rnw', eval=TRUE>>=
@
...
<<subdoc_content_titlepage, child='usr/subdocuments/ost_titlepage.Rnw', eval=T>>=
@
...
<<subdoc_content_introduction, child='usr/subdocuments/ost_introduction_section.Rnw', eval=T>>=
@
...
<<subdoc_content_introduction, child='usr/subdocuments/ost_affidavit_section.Rnw', eval=T>>=
@
...
<<subdoc_content_material_methods, child='usr/subdocuments/ost_material_methods_section.Rnw', eval=T>>=
@
...
<<subdoc_content_results, child='usr/subdocuments/ost_results_section.Rnw', eval=T>>=
@
...
<<subdoc_content_discussion, child='usr/subdocuments/ost_discussion_section.Rnw', eval=T>>=
@
...
<<subdoc_content_acknowledgement, child='usr/subdocuments/ost_acknowledgements_section.Rnw', eval=T>>=
@
...
<<body_mainmatter_chapter_one, child='usr/subdocuments/ost_appendix_section.Rnw', eval=TRUE>>=
@
...
<<body_mainmatter_chapter_one, child='usr/subdocuments/ost_glossaries_section.Rnw', eval=TRUE>>=
@
...
<<options_bibliography, child='usr/subdocuments/ost_bibliography_section.Rnw', eval=T>>=
@
