...
\documentclass[color=false, csvdata=false]{ost/subdocuments/open_science_thesis} 
...
\begin{titlepage}
%\CenterBackgroundPic{Bilder/PowerPlant.png}
  \vspace*{\stretch{1}}
  \ostTitleRule
  \vspace{1em}
  \begin{center}
...
% <<subdoc_content_header, child='usr/subdocuments/ost_header.Rnw', eval=T>>=
% @
...
% <<subdoc_content_abstract, child='usr/subdocuments/ost_abstract_section.Rnw', eval=T>>=
% @
