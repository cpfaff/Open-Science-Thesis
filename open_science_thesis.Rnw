...
\documentclass[color = true, orange = true, BCOR=5mm]{ost/subdocuments/open_science_thesis} 
...
%   option can be used to start the thesis on a left or right page.  (remove?) 
